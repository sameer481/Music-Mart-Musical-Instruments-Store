...
import './StudioBundleSection.css';
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {STUDIO_BUNDLES.map((bundle) => {
            const convertedPrice = (bundle.bundlePrice * curr.rate).toLocaleString('en-IN', { maximumFractionDigits: 2 });
            const convertedOriginal = (bundle.originalTotal * curr.rate).toLocaleString('en-IN', { maximumFractionDigits: 2 });
            const convertedSavings = (bundle.savings * curr.rate).toLocaleString('en-IN', { maximumFractionDigits: 2 });
